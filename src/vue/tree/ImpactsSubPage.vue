<template>
    ...
    <v-card v-else>
        ...
        <transition name="slide-fade" mode="out-in">
            ...
            <fragment-list v-else-if="idx === 1" :tree="tree" :fragment="IMPACTS" none="Pas encore d'informations sur les impacts sur l'environnement" key="1" note="Note: Vous êtes en train de regarder les impacts déclarés au niveau du produit sans compter ceux des ressources."></fragment-list>
        </transition>
